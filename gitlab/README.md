...
> ℹ️ Вместе с созданными ресурсами в Yandex Cloud в текущей директории будет создан файл `.key.json`, который будет содержать авторизационные данные сервисного аккаунта. Содержание данного файла можно использовать в качестве авторизационного ключа для выполнения действий от имени этого аккаунта, например, в CI/CD. 
