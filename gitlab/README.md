...
> ℹ️ Вместе с созданными ресурсами в Yandex Cloud будет создан файл `.key.json`, который будет содержать авторизационные данные сервсисного аккаунта. Содержание данного файла можно использовать в качестве авторизационного ключа для выполнения действий от имени сервисного аккаунта, например, в CI/CD. 
